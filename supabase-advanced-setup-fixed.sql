-- ADVANCED SUPABASE SETUP - FIXED VERSION
...
BEGIN
    ...
    SELECT json_build_object(
        ...
        'peak_productivity_day', (
            ...
            FROM tasks 
            WHERE user_id = user_id AND archived = true
...
-- Trigger to update project task counts in real-time (FIXED)
...
-- Success message
SELECT 'Advanced Supabase setup completed successfully! 🚀' as status;